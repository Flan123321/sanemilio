...
class PropertyManager {
    ...
    _loadFallback() {
        ...
        this.properties = [
            ...
            { id: 16, titulo: 'Casa en Arriendo – Villa Santa Luisa, Temuco', precioCLP: 0, operacion: 'arriendo', tipo: 'casa', region: 'La Araucanía', comuna: 'Temuco', dormitorios: 3, banos: 1, m2Utiles: 80, m2Terreno: 150, lat: -38.7582, lng: -72.6708, imagenPrincipal: PH, galeria: [], caracteristicas: ['patio','jardin','dos pisos'], destacada: false },
            { id: 17, titulo: 'Departamento en Arriendo – Torre Thiers, Piso 11, Temuco', precioCLP: 500000, operacion: 'arriendo', tipo: 'departamento', region: 'La Araucanía', comuna: 'Temuco', dormitorios: 2, banos: 2, m2Utiles: 65, lat: -38.7398, lng: -72.6043, imagenPrincipal: PH, galeria: [], caracteristicas: ['estacionamiento','orientacion norte','piso alto'], destacada: true },
            { id: 18, titulo: 'Departamento Remodelado en Arriendo – Condominio Lomas de Javiera, Temuco', precioCLP: 360000, operacion: 'arriendo', tipo: 'departamento', region: 'La Araucanía', comuna: 'Temuco', dormitorios: 3, banos: 1, m2Utiles: 55, lat: -38.7229, lng: -72.6252, imagenPrincipal: PH, galeria: [], caracteristicas: ['estacionamiento','logia','condominio seguro','remodelado'], destacada: false },
            { id: 19, titulo: 'Departamento en Venta – Edificio Alpes, Sector Senador Estébanez, Temuco', precioCLP: 0, precioUF: 3990, operacion: 'venta', tipo: 'departamento', region: 'La Araucanía', comuna: 'Temuco', dormitorios: 3, banos: 3, m2Utiles: 100, lat: -38.7330, lng: -72.6130, imagenPrincipal: PH, galeria: [], caracteristicas: ['estacionamiento','bodega','balcon','calefaccion central','ascensor'], destacada: true },
            { id: 20, titulo: 'Departamento en Arriendo – Condominio Valle de Javiera, Temuco', precioCLP: 0, operacion: 'arriendo', tipo: 'departamento', region: 'La Araucanía', comuna: 'Temuco', dormitorios: 2, banos: 1, m2Utiles: 55, lat: -38.7240, lng: -72.6320, imagenPrincipal: PH, galeria: [], caracteristicas: ['condominio seguro','areas verdes'], destacada: false },
            { id: 21, titulo: 'Casa en Arriendo – Labranza, Temuco', precioCLP: 450000, operacion: 'arriendo', tipo: 'casa', region: 'La Araucanía', comuna: 'Labranza', dormitorios: 2, banos: 2, m2Utiles: 90, m2Terreno: 200, lat: -38.7620, lng: -72.7580, imagenPrincipal: PH, galeria: [], caracteristicas: ['estacionamiento','logia','salon eventos'], destacada: true },
            { id: 22, titulo: 'Casa en Venta – Gorbea, a dos cuadras de la plaza', precioCLP: 85000000, operacion: 'venta', tipo: 'casa', region: 'La Araucanía', comuna: 'Gorbea', dormitorios: 3, banos: 1, m2Utiles: 70, m2Terreno: 200, lat: -39.1006, lng: -72.6764, imagenPrincipal: PH, galeria: [], caracteristicas: ['apta subsidio','regularizada','bodega'], destacada: false },
            { id: 23, titulo: 'Casa en Venta – Sector Molco, Pucón', precioCLP: 0, operacion: 'venta', tipo: 'casa', region: 'La Araucanía', comuna: 'Villarrica', dormitorios: 3, banos: 1, m2Utiles: 80, m2Terreno: 500, lat: -39.3000, lng: -72.1000, imagenPrincipal: PH, galeria: [], caracteristicas: ['lago cerca','naturaleza','madera'], destacada: true },
            { id: 24, titulo: 'Parcela en Venta – Los Tilos, Los Ángeles', precioCLP: 0, operacion: 'venta', tipo: 'parcela', region: 'Biobío', comuna: 'Los Ángeles', dormitorios: 0, banos: 0, m2Utiles: 0, m2Terreno: 5000, lat: -37.4707, lng: -72.3517, imagenPrincipal: PH, galeria: [], caracteristicas: ['naturaleza','terreno delimitado'], destacada: false },
            { id: 25, titulo: 'Tres Parcelas en Venta – Sector Colicheo, Temuco', precioCLP: 0, operacion: 'venta', tipo: 'parcela', region: 'La Araucanía', comuna: 'Temuco', dormitorios: 0, banos: 0, m2Utiles: 0, m2Terreno: 15000, lat: -38.8200, lng: -72.6100, imagenPrincipal: PH, galeria: [], caracteristicas: ['naturaleza','rio','tres parcelas'], destacada: false },
            { id: 26, titulo: 'Hermosa Casa en Venta – Fundo El Carmen, Temuco', precioCLP: 175000000, operacion: 'venta', tipo: 'casa', region: 'La Araucanía', comuna: 'Temuco', dormitorios: 4, banos: 2, m2Utiles: 120, m2Terreno: 250, lat: -38.7128, lng: -72.6564, imagenPrincipal: PH, galeria: [], caracteristicas: ['dos pisos','patio','sector tranquilo'], destacada: true },
            { id: 27, titulo: 'Parcela en Venta – Molco Alto, Villarrica', precioCLP: 0, operacion: 'venta', tipo: 'parcela', region: 'La Araucanía', comuna: 'Villarrica', dormitorios: 0, banos: 0, m2Utiles: 0, m2Terreno: 5000, lat: -39.3500, lng: -72.0800, imagenPrincipal: PH, galeria: [], caracteristicas: ['bosque nativo','naturaleza','precordillera'], destacada: false },
            { id: 28, titulo: 'Casa en Venta – Rahue Alto, Calle Pisagua, Osorno', precioCLP: 140000000, operacion: 'venta', tipo: 'casa', region: 'Los Lagos', comuna: 'Osorno', dormitorios: 2, banos: 2, m2Utiles: 80, m2Terreno: 200, lat: -40.5838, lng: -73.1694, imagenPrincipal: PH, galeria: [], caracteristicas: ['quincho','bodega','estacionamiento'], destacada: true }
        ];
    }
...
// Lock scroll immediately on script execution
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const hidePreloader = () => {
        ...
        setTimeout(() => {
            // Step 1: Trigger the 360 spin
            if (logo) {
                logo.classList.add("spin");
            }

            // Step 2: Slide preloader right after spin finishes (800ms)
            setTimeout(() => {
                preloader.classList.add("slide-right");
                document.body.classList.remove("preloader-active");

                // Step 3: Remove display completely after slide animation (800ms)
                setTimeout(() => {
    ...
    // Fallback: hide preloader anyway after 4 seconds in case load event hangs
